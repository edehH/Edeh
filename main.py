...
def web_main():
    ...
    <style>
        ...
        .container {
            ...
            margin: 0 auto;
            padding: 20px;
            background: rgba(255,255,255,0.65); /* شفافية خفيفة */
            border-radius: 8px;
        ...
        #codeArea {
            ...
            font-size: 14px;
            background-color: white; /* أبيض واضح */
...
def main():
    ...
    <div class="container">
        ...
        <div style="font-size:18px; line-height:1.8;">
            <div>21. 😂 ليش المبرمج يحب يستخدم الكومبيوتر؟ لأنه مكان ما فيهوش <b>bugs</b>... قصدي صراصير!</div>
            <div>22. 😄 كيف تعرف إن المبرمج مبسوط؟ لما يكون الكود تبعه <b>compile</b> من أول مرة!</div>
            <div>23. 🤔 وش الفرق بين المبرمج الكويس والمبرمج اللي مش كويس؟ الكويس بيكتب كود محد يفهمه، واللي مش كويس بيكتب كود حتى هو ما يفهمه!</div>
            <div>24. 😡 ليش المبرمج لما يعصب يروح يكتب كود؟ عشان يطلع اللي في قلبه على شكل <b>errors</b>!</div>
            <div>25. 😍 وش يقول المبرمج حق الـ <b>front-end</b> لما يشوف تصميم حلو؟ "يا له من <b>CSS</b> ساحر!"</div>
            <div>26. 😫 ليش المبرمج ما يحب الأفلام الطويلة؟ لأنه ما فيها <b>Ctrl + F</b> عشان يدور على الأحداث المهمة!</div>
            <div>27. 🤪 وش يسوي المبرمج لما يحس بالملل؟ يقعد يدور على <b>infinite loops</b> في الكود تبعه!</div>
            <div>28. 🛠️ كيف المبرمج يصلح سيارته؟ يستخدم مفتاح <b>F12</b> عشان يشوف الـ <b>console</b>!</div>
            <div>29. 🤥 ليش المبرمج لما يتكلم عن مشكلة يقول "It's not a bug, it's a feature"? عشان يحس إنه مسوي شيء متعمد!</div>
            <div>30. 😎 وش أحلى شعور عند المبرمج؟ لما يلاقي حل لمشكلة قعد عليها أيام ويطلع سطر واحد!</div>
            <div>31. ☕ ليش المبرمج يحب الشاي والقهوة؟ عشان تساعده يسوي <b>debug</b> لعقله!</div>
            <div>32. 🥺 وش يقول المبرمج لما يعلق جهازه؟ "يا <b>Kernel</b> يا حبيبي!"</div>
            <div>33. ❤️ كيف المبرمج يعبر عن حبه؟ يكتب كود فيه <b>comments</b> كلها قلوب!</div>
            <div>34. 🤓 ليش المبرمج لما يشتري شيء جديد ما يقرأ الـ <b>manual</b>؟ لأنه متعود يتعامل مع الـ <b>documentation</b>!</div>
            <div>35. ⏪ وش يسوي المبرمج لما يخرب الكود تبعه؟ يسوي <b>Ctrl + Z</b> ألف مرة!</div>
            <div>36. 📡 ليش المبرمج لما يروح مكان جديد يدور على الـ <b>Wi-Fi</b>؟ عشان يتأكد إنه متصل بالعالم!</div>
            <div>37. 🎉 وش يقول المبرمج لما ينجح مشروعه؟ "Finally, no more <b>segmentation fault</b>!"</div>
            <div>38. 😬 كيف المبرمج يحتفل بنهاية مشروع؟ يسوي <b>git push --force</b> على فرع الـ <b>main</b>! (طبعا هذا على مسؤوليته!)</div>
            <div>39. ✈️ ليش المبرمج لما يسافر ياخذ معاه لاب توب؟ عشان يمكن يحتاج يسوي <b>hotfix</b> وهو في المطار!</div>
            <div>40. 👍 وش نصيحة المبرمج للمبتدئين؟ "لا تخافوا من الـ <b>errors</b>، تراها مجرد رسائل حب من الكومبيوتر!"</div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div style="font-size:18px; line-height:1.8;">
            <div>1. ❄️ ليش المبرمج دايمًا بارد؟ لأنه يتعامل مع الـ <b>cache</b>!</div>
            <div>2. 💤 مبرمج نام وهو يحل مشكلة... صحى لقاه <b>feature</b> مو <b>bug</b>!</div>
            <div>3. 🍳 مبرمج دخل مطعم، سألوه: كيف تفضل البيض؟ قال: <b>Boolean</b>... إما مسلوق أو لا.</div>
            <div>4. 🌊 لماذا يكره المبرمج البحر؟ لأنه مليان <b>crashes</b>.</div>
            <div>5. 🧠 مبرمج تقدم لوظيفة، سألوه عن خبرته؟ قال: عندي <b>Git commit history</b> أطول من حياتي!</div>
            <div>6. 🧘‍♂️ كيف يعالج المبرمج الاكتئاب؟ يعمل <b>debug</b> لمشاعره.</div>
            <div>7. 🌙 ليش المبرمجين يحبون الليل؟ لأن الدنيا تصير <b>dark mode</b> طبيعي!</div>
            <div>8. 👶 لما المبرمج يتزوج، وش يسمي أولاده؟ <b>Array[0]</b>، <b>Array[1]</b>...</div>
            <div>9. 🥪 مبرمج فتح ثلاجة، كتب: <b>if (food == true) eat(); else sleep();</b></div>
            <div>10. 🧭 ليش الم
""")
