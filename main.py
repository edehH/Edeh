...
def web_main():
    put_html("""
    <head>
        <meta name="google-site-verification" content="BqrWiy1OS0O49OAB_JIwoqw1V74uDlHKOP5EIEqrKvs" />
        <style>
            body {
            ...
            .social-image {
                ...
                height: 60px; /* هذا مكان تغيير ارتفاع الصورة */
                margin: 10px;
                border-radius: 8px;
                cursor: pointer;
...
def main():
    ...
    """)
Add verification fileAdd verification fileAdd verification file
if __name__ == '__main__':
    PORT = int(os.getenv("PORT", 10000))
    start_server(web_main, port=PORT, debug=True)
